...
theme.Product = (function() {
    function Product(container) {
        ...
        $(".reviewLink, .moredetail a").on('click', function(e) {
            ...
            if ($(window).width() < 767) {
                $("html, body").animate({
                    scrollTop: tabposition.top - 100
                }, 700);
            } else {
                $("html, body").animate({
                    scrollTop: tabposition.top - 150
                }, 700);
            }
        });
        ...
        _initThumbnailSlider: function() {
            ...
            $('.primgSlider').on('afterChange', function(event, slick, currentSlide) {
                ...
                if ($('.slick-current model-viewer').length) {
                    $('.slick-current .shopify-model-viewer-ui__button--poster').trigger('click')
                }
            });
        ...
        $(document).on('click touch', '.quickShop', function(e) {
            ...
            $.ajax({
                ...
                complete: function(data) {
                    ...
                    if (theme.mlcurrency) {
                        currenciesChange(".shopWrapper.active .product-single__price span.money");
                    }
                }
            });
        });
