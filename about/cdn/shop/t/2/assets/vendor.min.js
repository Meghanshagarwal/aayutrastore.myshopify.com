...
function(t, e) {
    var i = function(t, e) {
        ...
        if (e.getElementsByClassName) {
            ...
            var _ = function() {
                    var s, d, p, h, v, T, _, I, P, O, j, M, L = /^img$/i,
                        N = /^iframe$/i,
                        ...
                        R = function(t, i) {
                            var n, o = t,
                                s = q(t);
                            for (I -= i, j += i, P -= i, O += i; s && (o = o.offsetParent) && o != e.body && o != r;)(s = (S(o, "opacity") || 1) > 0) && "visible" != S(o, "overflow") && (n = o.getBoundingClientRect(), s = O > n.left && P < n.right && j > n.top - 1 && I < n.bottom + 1);
                            return s
                        },
                        W = function() {
                            ...
                            if ((h = n.loadMode) && F < 8 && (t = w.length)) {
                                ...
                                } else !c && d && !u && F < 4 && D < 4 && h > 2 && (s[0] || n.preloadAfterLoad) && (s[0] || !v && (j || O || P || I || "auto" != w[o][l](n.sizesAttr))) && (u = s[0] || w[o]);
                                u && !c && G(u)
                            }
                        },
                        Q = A(W),
...
function() {
    ...
    var zt = w("length"),
        ...
        Ht = m;
    a.prototype = u(s.prototype), a.prototype.constructor = a, s.assignIn = jt, s.before = O, s.bind = At, s.chain = function(t) {
    ...
    }, s.values = X, s.extend = jt, K(s, s), s.clone = function(t) {
    ...
    function(t) {
        ...
        t.magnificPopup.registerModule(I, {
            ...
            proto: {
                initAjax: function() {
                    e.types.push(I), E = e.st.ajax.cursor, w(a + "." + I, O), w("BeforeChange." + I, O)
                },
                getAjax: function(i) {
                    ...
                    var i = 0,
                        ...
                        r = function(o) {
                            j && clearInterval(j), j = setInterval(function() {
                                return n.naturalWidth > 0 ? void e._onImageHasSize(t) : (i > 200 && clearInterval(j), void(3 === ++i ? r(10) : 40 === i ? r(50) : 100 === i && r(500)))
                            }, o)
                        };
                    r(1)
                },
    ...
    function() {
        ...
        e = function() {
            ...
            return null == e && (e = {}), i.configure(e), i.Utils.log("Initialising CartJS."), i.cart.update(t), i.settings.dataAPI && (i.Utils.log('"dataAPI" setting is true, initialising Data API.'), i.Data.init()), i.settings.requestBodyClass && (i.Utils.log('"requestBodyClass" set, adding event listeners.'), jQuery(document).on("cart.requestStarted", function() {}), jQuery(document).on("cart.requestComplete", function() {})), i.Rivets.init(), jQuery(document).trigger("cart.ready", [i.cart])
